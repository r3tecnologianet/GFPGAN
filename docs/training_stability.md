...
- **The continuous law buys nothing.** The two-point draw is ahead of Beta(0.5, 1) by 0.012 dB [-0.043, +0.066], p=0.52, 32 of 64 -- a tie bounded to within 0.066 dB, not a tie for want of statistical power. At 1,250 iterations the simpler law was marginally ahead (+0.082 dB, p=0.0015). The extra option, the extra dataset branch and the four-parameter interpolation are not paid for.
